...
IL_0045:
	...
	}
	{
		...
		NotSupportedException__ctor_mE174750CF0247BBB47544FFD71D66BB89630945B(L_18, ((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral393DDC767F48626B0317297F8A961E12A2DFC6B6)), /*hidden argument*/NULL);
	...
	}
{
	...
	}
	{
		...
		ArrayList__ctor_m07DC369002304B483B9FC41DBDAF4A25AC3C9F80(L_2, /*hidden argument*/NULL);
...
ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* V_0 = NULL;
	...
	}
	{
		...
		ArrayList__ctor_m07DC369002304B483B9FC41DBDAF4A25AC3C9F80(L_1, /*hidden argument*/NULL);
		V_4 = L_1;
...
IL_0002:
	...
	}
	{
		...
		ASN1__ctor_mAA538F9E1BE0DE739E9747BC3BC71DC030B018AA(L_5, L_3, L_4, /*hidden argument*/NULL);
...
IL_0020:
	{
		...
		ASN1__ctor_mA9AE2197367C1E13DBFDA67E0A383167F52CC114(L_10, (uint8_t)2, /*hidden argument*/NULL);
		V_2 = L_10;
		int32_t L_11 = V_1;
		if (!L_11)
		{
...
int32_t V_0 = 0;
	...
	}
	{
		...
		ArgumentNullException__ctor_m444AE141157E333844FC1A9500224C2F9FD24F4B(L_1, ((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral64EF02A69B970330DD01FA1A603CAE5EFC04FB89)), /*hidden argument*/NULL);
...
IL_000e:
	...
	}
	{
		...
		FormatException__ctor_mE04AEA59C0EEFF4BD34B7CE8601F9D331D1D473E(L_4, ((String_t*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&_stringLiteral07C3F7BAA7B4AB0D6D2DA7749FA8ACA206FD73F8)), /*hidden argument*/NULL);
...
IL_000e:
	{
		...
		StringBuilder__ctor_m1D99713357DE05DAFA296633639DB55F8C30587D(L_4, /*hidden argument*/NULL);
		V_1 = L_4;
		ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* L_5 = V_0;
		int32_t L_6 = 0;
